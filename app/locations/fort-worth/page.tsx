...
// Pilot location page #2 — see app/locations/dallas/page.tsx for the
// reasoning behind the pattern; kept the same shape deliberately so the
// two pilots prove one consistent system, not two different approaches.
    ...
    <>
      <nav aria-label="Breadcrumb" className="breadcrumbs container">
        <ol>
          ...
          <li>
            <span aria-current="page">Fort Worth, TX</span>
          </li>
        </ol>
      </nav>

      <section className="page-hero container">
        <h1>Phone Repair in Fort Worth, TX</h1>
        <QuickAnswer>
          CPRNME helps Fort Worth-area customers find the right phone repair.
      ...
      <section className="section container">
        <h2>Fort Worth spans a wide area</h2>
        <div className="prose">
          <p>
            ...
            what&rsquo;s available, rather than assuming one answer covers
            the whole city.
          </p>
        </div>
      </section>
      ...
      <section className="section container" aria-labelledby="fw-faq-heading">
        <h2 id="fw-faq-heading">Common questions</h2>
        <div className="faq-list">
          <details className="faq-item">
            <summary>Does CPRNME serve every part of Fort Worth?</summary>
            <p>
