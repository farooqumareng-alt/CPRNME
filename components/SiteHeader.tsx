// Server component — no client JS needed, apart from the "Find My Repair"
// link itself (see FindRepairLink.tsx). Links use absolute paths
  ...
  return (
    <header className="site-header">
      <div className="container site-header-inner">
        ...
        <FindRepairLink className="btn btn-primary btn-compact">
          Find My Repair
        </FindRepairLink>
      </div>
    </header>
